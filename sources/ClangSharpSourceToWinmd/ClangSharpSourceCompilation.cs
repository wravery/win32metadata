    ...
    public class ClangSharpSourceCompilation
    {
            ...
            Dictionary<string, string> staticLibs)
        {
            ...
            System.Threading.Tasks.Parallel.ForEach(syntaxTrees, opt, (tree) =>
            {
                ...
                var cleanedTree = MetadataSyntaxTreeCleaner.CleanSyntaxTree(tree, nativeTypes, remaps, enumAdditions, enumsMakeFlagsHashSet, requiredNamespaces, staticLibs, emptyStucts, enumMemberNames, modifiedFile);
